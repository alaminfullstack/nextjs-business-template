        ...
        <div className="row">
          <div className="col-xl-10 text-center mx-auto">
            ...
            <p className="lead mb-0">
              We are an insight and behaviors driven creative marketing agency.
                ...
                <div className="text-end position-relative d-none d-md-block">
                  ...
                  <figure className="position-absolute top-0 start-50 ms-n7">
                    <svg
                      ...
                      height="96px"
                      viewBox="0 0 106 96"
                      style={{ enableBackground: "new 0 0 106 96" }}
                      xmlSpace="preserve"
                    >
                ...
                <div className="card card-body overflow-hidden p-0">
                  ...
                  <div className="position-absolute end-0 bottom-0 m-3 z-index-2">
                    <a
                      ...
                      className="btn btn-lh btn-white"
                      data-gallery="course-video"
                    >
                      <i className="bi bi-youtube text-danger fa-fw fa-xl me-1"></i>{" "}
                      Watch our story
                    </a>
                  </div>
                </div>
