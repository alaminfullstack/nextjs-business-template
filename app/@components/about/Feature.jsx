            ...
            <div className="container">
                <div className="row g-4 align-items-center">
                    ...
                    <div className="col-lg-6 ps-xl-7">
                        ...
                        <p>Our story begins with a vision â€“ a vision to transform the digital experience for businesses of all sizes. Over the years, we've evolved from a small startup to a dynamic digital agency with a global footprint.</p>
                        ...
                        <Link className="btn btn-dark me-3 mb-0" href="/services">Explore services!</Link>
                        <Link className="icon-link icon-link-hover" href="/contact2">Request a quote<i className="bi bi-arrow-right"></i> </Link>
